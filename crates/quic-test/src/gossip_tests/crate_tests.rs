...
fn test_topic_id_creation() -> Result<(), String> {
    ...
    // Create from entity - different entities should produce different topics
    let topic2 = TopicId::from_entity("test-entity");
    let topic3 = TopicId::from_entity("other-entity");
    if topic2 == topic3 {
